 ...
 */
public class FResepmaincourse extends javax.swing.JFrame {
    private javax.swing.JTable JTMaincourse;

    /**
     * Creates new form FResepbreakfast
     */
    public FResepmaincourse() {
        JTMaincourse = new javax.swing.JTable();
        // Inisialisasi JTMaincourse dengan DefaultTableModel
        JTMaincourse.setModel(new DefaultTableModel());
        initComponents();
        centerFrame();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TAMBAH RESEP MAIN COURSE");
    ...
    private void BSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BSimpanActionPerformed
        try {
        // Membuat query SQL untuk menambahkan data ke tabel maincourse berdasarkan nilai dari komponen-komponen UI
        String sql = "INSERT INTO maincourse VALUES ('"+TFKode.getText()+"','"+TFNama.getText()+"','"+JTABahan.getText()+"','"+TFApprove.getText()+"','"+JTACaramasak.getText()+"') ";
        ...
        // Menjalankan query untuk menyimpan data ke dalam tabel maincourse
        pst.execute();
        ...
        // Bersihkan field di FResepMaincourse setelah disimpan
        TFKode.setText("");
        TFNama.setText("");
        JTABahan.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FResepmaincourse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FResepmaincourse().setVisible(true);
            }
        });
    }
