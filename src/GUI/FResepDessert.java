 ...
 */
public class FResepDessert extends javax.swing.JFrame {
    private javax.swing.JTable JTDessert;

    /**
     * Creates new form FResepdessert
     */
    public FResepDessert() {
        JTDessert = new javax.swing.JTable();
        // Inisialisasi JTBreakfast dengan DefaultTableModel
        JTDessert.setModel(new DefaultTableModel());
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TAMBAH RESEP DESSERT");
    ...
    private void BSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BSimpanActionPerformed
        try {
        // Membuat query SQL untuk menambahkan data ke tabel dessert berdasarkan nilai dari komponen-komponen UI
        String sql = "INSERT INTO dessert VALUES ('"+TFKode.getText()+"','"+TFNama.getText()+"','"+JTABahan.getText()+"','"+TFApprove.getText()+"','"+JTACaramasak.getText()+"') ";
        ...
        // Menjalankan query untuk menyimpan data ke dalam tabel dessert
        pst.execute();
        ...
        // Bersihkan field di FResepDessert setelah disimpan
        TFKode.setText("");
        TFNama.setText("");
        JTABahan.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FResepDessert.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FResepDessert().setVisible(true);
            }
        });
    }
