 ...
 */
public class FEResepdessert extends javax.swing.JFrame {
    // Mendeklarasikan variabel fDessert sebagai referensi ke instans FDessert
    private FDessert fDessert;

    /**
     * Konstruktor kelas FEResepdessert.
     * @param fDessert Referensi ke instans FDessert yang digunakan untuk mengakses data terpilih.
     */
    public FEResepdessert(FDessert fDessert) {
        initComponents();
        // Menyimpan referensi fDessert yang diteruskan sebagai parameter ke variabel instans fDessert
        this.fDessert = fDessert;

        // Mengakses data terpilih dari FDessert
        String kodemasakan = fDessert.getSelectedKode();
        String nama = fDessert.getSelectedNama();
        String bahan = fDessert.getSelectedBahan();
        String approve = fDessert.getSelectedApprove();
        String caramasak = fDessert.getSelectedCaraMasak();
    ...
    /**
     * Creates new form FEResepdessert
     */
    public FEResepdessert() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("EDIT RESEP DESSERT");
    ...
    private void BKembaliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BKembaliActionPerformed
        ...
        // Menampilkan kembali frame FDessert
    ...
    private void BSimpanperubahanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BSimpanperubahanActionPerformed
        ...
        String sql = "UPDATE dessert SET nama='" + nama + "', bahan='" + bahan + "', approve='" + approve + "', caramasak='" + caraMasak + "' WHERE kodemasakan='" + kodeMasakan + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FEResepdessert.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FEResepdessert().setVisible(true);
            }
        });
    }
